# Archived 2026-04-26 — replaced by Generals roster. See personas/personas.py.
...
LEGACY_PERSONAS: dict[str, Persona] = {
    "roomba_noah": Persona(
        id="roomba_noah",
        name="Roomba Noah",
...
""",
    ...
    "rat_main_noah": Persona(
        ...
        play_depth=9,
        strategy=StrategyProfile(
            opening_bias=("sicilian", "caro-kann"),
            risk_tolerance=0.75,
...
LEGACY_DEFAULT_PERSONA_ID = "clown_noah"
